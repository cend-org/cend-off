...
func GetProfileLetterThumb(ctx context.Context) (*string, error) {
	...
	media, err = GetCurrentUserLetterThumb(tok.UserId)
	if err != nil {
		return &networkLink, errx.DbGetError
...
func GetCurrentUserLetterThumb(userId int) (media model.MediaThumb, err error) {
...
func GetCurrentUserLetter(userId int) (media model.Media, err error) {
...
func RemoveCurrentUserLetter(media model.Media) (err error) {
